...
namespace Tests.Core.Logic
{
    ...
    public class ConnectionValidatorTests
    {
        ...
        #region Road In/Road Out Rule Tests
        ...
        public void ValidateConnections_DeadEnd_IsInvalid()
        {
            ...
            Assert.IsTrue(result.Errors.Any(e => e.PathPoint == anotherNonEntityPoint && e.Severity == ErrorSeverity.Error));
        }
        ...
        public void ValidateConnections_EntityToEntityViaTwoPoints_IsValid()
        {
            ...
            var network = new PathNetworkState();
            int entity1Point = GridConfiguration.EntityToPathPoint[0];
            int entity2Point = GridConfiguration.EntityToPathPoint[1];
            int intermediatePoint1 = 13;
            int intermediatePoint2 = 14;
