namespace Core.Configuration
{
    ...
    public static class GridConfiguration
    {
        ...
        public static readonly int[][] SlotToPathPoints = new int[TotalSlots][]
        {
            // Slot 0 (top-left)
            new[] { 0, 13, 3, 12 },
        ...
        public static readonly int[] PathPointToEntity = new int[TotalPathPoints]
        {
            0,  // Point 0  -> Entity 0
            1,  // Point 1  -> Entity 1
            2,  // Point 2  -> Entity 2
        ...
        public static readonly int[] EntityToPathPoint = new int[TotalEntities]
        {
            0,  // Entity 0  -> Point 0
            1,  // Entity 1  -> Point 1
            2,  // Entity 2  -> Point 2
        ...
        {
            bool isEntity = IsEntityPoint(pathPoint);
